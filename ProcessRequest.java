...
public class ProcessRequest extends aos.jack.jak.plan.Plan {
    ...
    private ProcessRequest(aos.jack.jak.task.Task __t, stockMarket.ProcessRequest __env)
    {
    ...
    public boolean init_sentinel(aos.jack.jak.agent.NameSpace __a)
    {
        ...
        fev = (investor.Finished) __a.findEvent("investor.Finished");
        if (fev == null) {
            warning("Failed to find Finished fev");
            return false;
        }
        ...
        companyList = (stockMarket.OrderBook) lookupNamedObject("companyList","stockMarket.OrderBook",0);
        if (companyList == null) {
            warning("Failed to find OrderBook companyList");
            return false;
        }
        return true;
    }
    ...
    {
        return new stockMarket.ProcessRequest.__bodyFSM();
    }
    
    public aos.jack.jak.plan.PlanFSM fail()
    {
        return new stockMarket.ProcessRequest.__failFSM();
    }
    
    private ProcessRequest(stockMarket.MessageBuy __ev, aos.jack.jak.task.Task __t, stockMarket.ProcessRequest __env)
    {
        this(__t,__env);
        this.ev = __ev;
    }
    ...
    public aos.jack.jak.plan.Plan createPlan(aos.jack.jak.event.Event __e, aos.jack.jak.task.Task __t)
    {
        ...
        return new stockMarket.ProcessRequest(__e1,__t,this);
    }
    ...
    public java.lang.Object getVariable(int n)
    {
        switch (n) {
            ...
            case 5: 
            {
                return aos.util.ToObject.box(companyList);
            }
            default: 
            {
    ...
    class __bodyFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    ...
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ProcessRequest.body:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    if (__state < 10) {
                        __status = super.stdrun(stockMarket.ProcessRequest.this,__status);
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ProcessRequest.body: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (39)         companyList.getDetails(ev.company,$price,$shares);
                        case 10: 
                        {
                            __breakLevel = 0;
                            boolean __b;
                        ...
                        //* (40)         @send(ev.from,fev.finished("sold! ",$price.getValue()*ev.amountOfShares));
                        case 11: 
                        {
                            __state = 12;
                        ...
                        //* (41)         companyList.remove(ev.company,$price.getValue(),$shares.getValue());
                        case 12: 
                        {
                            __state = 13;
                        ...
                        //* (42)         System.out.println("freacking handled !");
                        case 13: 
                        {
                            __state = 14;
                            java.lang.System.out.println("freacking handled !");
                            break;
                        }
                        //* (36)     #reasoning method
                        case 14: 
            ...
            throws java.lang.Exception
        {
            switch (__index) {
                case 0: 
                {
                    return (companyList.getDetails(ev.company,$price,$shares));
                }
            }
            aos.jack.jak.core.Jak.error("illegal Cursor Construction");
            return null;
        ...
        {
            return stockMarket.ProcessRequest.this;
        }
        ...
        public void enter()
        {
            __trace = agent.trace("stockMarket.ProcessRequest.body");
        }
    ...
    class __failFSM extends aos.jack.jak.plan.PlanFSM implements aos.jack.jak.core.Generator {
            ...
            do {
                try {
                    if (__tothrow != null) 
                        throw __tothrow;
                    if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_PLANS) != 0) 
                        aos.util.logging.LogMsg.log(this,aos.jack.jak.core.Jak.LOG_PLANS,__task + "-ProcessRequest.fail:" + java.lang.Integer.toString(__state));
                    if (__task.nsteps > 0) {
                        __task.nsteps-- ;
                        if (__task.nsteps == 0) 
                            agent.changeFocus();
                    ...
                    switch (__state) {
                        default: 
                        {
                            aos.jack.jak.core.Jak.error("ProcessRequest.fail: Illegal state");
                            return FAILED_STATE;
                        }
                        //* (48)         @send(ev.from,fev.finished("sorry! can't sell ",0));
                        case 10: 
                        {
                            __breakLevel = 0;
                            __state = 11;
        ...
        public void enter()
        {
            __trace = agent.trace("stockMarket.ProcessRequest.fail");
        }
