...
public class OrderBook__Tuple extends aos.jack.jak.beliefset.Tuple implements aos.apib.Base, java.io.Serializable {
...
public OrderBook__Tuple(boolean v)
{
    super();
    isFree = v;
}
...
public int hash(int __i)
{
  ...
  public OrderBook__Tuple() {
    streamer.setup();
    if (!getStreamer().initialized) return;
    __init__OrderBook__Tuple();
  }

  /** Automatically generated method. */
  void __init__OrderBook__Tuple() {
	companyName = null;
	numberOfShares = 0;
	sharePrice = 0;
  ...
  static class __SS extends aos.apib.StreamerSupport {
    ...
    protected void setup() {
      ...
      __def = (OrderBook__Tuple)newInstance();
    ...
    protected void init() {
      setup();
      __def.__init__OrderBook__Tuple();
    }
    ...
    public aos.apib.Base new_instance() {
      return new OrderBook__Tuple();
    }

    /** JACOB method. */
    public aos.apib.Base[] new_array(int n) {
      return new OrderBook__Tuple[n];
    }
    ...
    public boolean readField(aos.apib.InStream in, aos.apib.Base o,int i) {
      ...
      OrderBook__Tuple v = (OrderBook__Tuple)o;
      switch (i) {
      case 0:
   ...
   case 2:
	...
	break;
      ...
      default:
        if (i >= 0 && i <= 3) break;
        in.error("Reader for OrderBook__Tuple: illegal field number:"+i);
        return false;
      }
      return true;
    }
   ...
   case 2:
	...
	break;
        ...
        default:
          if (i >= 0 && i <= 3) break;
          out.error("Writer for OrderBook__Tuple: illegal field number:"+i);
          return false;
        }
      }
      return true;
