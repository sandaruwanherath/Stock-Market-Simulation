...
public class CompanyList extends aos.jack.jak.beliefset.OpenWorld {
    static public stockMarket.CompanyList__Tuple __hole = new stockMarket.CompanyList__Tuple(true);
    public stockMarket.CompanyList__Tuple[][] __tables;
    ...
    {
        stockMarket.CompanyList__Tuple __t = new stockMarket.CompanyList__Tuple();
        stockMarket.CompanyList.__Cursor __c = new stockMarket.CompanyList.__Cursor(__t);
        __t.companyName = __v0;
        if (!__v1.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("CompanyList:getDetails:IOO: arg 1 numberOfShares Incorrect Variable type");
        if (__v1.isGround()) {
            try {
                __t.numberOfShares = __v1.as_int();
            }
            catch (java.lang.Exception e) {
                throw new aos.jack.jak.beliefset.BeliefSetException("CompanyList:getDetails:IOO: got " + e.toString());
            }
        }
         else 
            __c.numberOfShares = __v1;
        if (!__v2.check_unifiable(java.lang.Integer.TYPE)) 
            throw new aos.jack.jak.beliefset.BeliefSetException("CompanyList:getDetails:IOO: arg 2 sharePrice Incorrect Variable type");
        if (__v2.isGround()) {
            try {
    ...
    {
        return new stockMarket.CompanyList__Tuple();
    }
    ...
    {
        return new stockMarket.CompanyList__Tuple[t];
    }
    ...
    {
        __tables = (stockMarket.CompanyList__Tuple[][]) t;
    }
    
    public aos.jack.jak.beliefset.BeliefSetCursor newCursor(aos.jack.jak.beliefset.Tuple __t)
    {
        if (__t instanceof stockMarket.CompanyList__Tuple) 
            return new stockMarket.CompanyList.__Cursor((stockMarket.CompanyList__Tuple) __t);
        return null;
    }
    ...
    public CompanyList(java.lang.String n)
    {
        super();
        read(n);
    }
    ...
    class __Cursor extends aos.jack.jak.beliefset.OpenWorldCursor {
        public stockMarket.CompanyList__Tuple __tuple = null;
        ...
        public __Cursor(stockMarket.CompanyList__Tuple __t)
        {
            super();
            __tuple = __t;
        }
        ...
        {
            stockMarket.CompanyList__Tuple[] __tab = __tables[__ti];
            stockMarket.CompanyList__Tuple __t;
            int __sz = __tab.length;
            int __i;
            if ((aos.jack.jak.core.Jak.debugging & aos.jack.jak.core.Jak.LOG_DB) != 0) {
                aos.jack.jak.core.Jak.log.log("CompanyList__Tuple:match:" + __ti + ":" + __st + ":" + __c + ":" + __k + ":" + __ind);
